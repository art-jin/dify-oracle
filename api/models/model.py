...
class AppModelConfig(db.Model):
    ...
    configs = db.Column(AdjustedJSON(db.CLOB), nullable=True) #Oracle AdjustedJSON
    created_by = db.Column(StringUUID, nullable=True)
    created_at = db.Column(db.DateTime, nullable=False, server_default=func.current_timestamp())
    updated_by = db.Column(StringUUID, nullable=True)
    updated_at = db.Column(db.DateTime, nullable=False, server_default=func.current_timestamp())
...
class RecommendedApp(db.Model):
    ...
    id = db.Column(StringUUID, primary_key=True, server_default=db.text("SYS_GUID()"))  ##Oracle:
    app_id = db.Column(StringUUID, nullable=False)
    #description = db.Column(db.JSON, nullable=False)#Oracle
...
class Conversation(db.Model):
    ...
    #_inputs: Mapped[dict] = mapped_column("inputs", db.JSON) #Oracle
    _inputs: Mapped[dict] = mapped_column("inputs", AdjustedJSON)
...
class Message(db.Model):
    ...
    #message = db.Column(db.JSON, nullable=False)#Oracle
    message = db.Column(AdjustedJSON, nullable=False)
...
class OperationLog(db.Model):
    ...
    #content = db.Column(db.JSON)#Oracle
    content = db.Column(AdjustedJSON)
    created_at = db.Column(db.DateTime, nullable=False, server_default=func.current_timestamp())
...
class UploadFile(db.Model):
    ...
    #id: Mapped[str] = db.Column(StringUUID, default=lambda: uuid.uuid4())
    id: Mapped[str] = db.Column(StringUUID, server_default=db.text("SYS_GUID()"))  ##Oracle:
    tenant_id: Mapped[str] = db.Column(StringUUID, nullable=False)
...
class TraceAppConfig(db.Model):
    ...
    #tracing_config = db.Column(db.JSON, nullable=True) #Oracle
    tracing_config = db.Column(AdjustedJSON, nullable=True)
    created_at = db.Column(db.DateTime, nullable=False, server_default=func.current_timestamp())
