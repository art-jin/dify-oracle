...
from .types import AdaptiveText, StringUUID ##MySQL/Oracle
...
class Account(UserMixin, db.Model):
    ...
    #id = db.Column(StringUUID, default=lambda: uuid.uuid4()) ##:MySQL/Oracle
    id = db.Column(StringUUID, server_default=db.text("SYS_GUID()")) ##:Oracle
    ...
    ##status = db.Column(db.String(16), nullable=False, default="active") ##:MySQL/Oracle
    status = db.Column(db.String(16), nullable=False, server_default=db.text("'active'")) ##Oracle
...
class Tenant(db.Model):
    ...
    #plan = db.Column(db.String(255), nullable=False, default="basic")     ##:MySQL/Oracle
    plan = db.Column(db.String(255), nullable=False, server_default=db.text("'basic'"))     ##:Oracle
    #status = db.Column(db.String(255), nullable=False, default="normal")  ##:MySQL/Oracle
    status = db.Column(db.String(255), nullable=False, server_default=db.text("'normal'")) ##:Oracle
...
class TenantAccountJoin(db.Model):
    ...
    #id = db.Column(StringUUID, default=lambda: uuid.uuid4())  ##:MySQL/Oracle
    id = db.Column(StringUUID, server_default=db.text("SYS_GUID()"))  ##Oracle:SYS_GUID()
    tenant_id = db.Column(StringUUID, nullable=False, server_default=db.text("SYS_GUID()"))##Oracle:SYS_GUID()
...
class InvitationCode(db.Model):
    ...
    #status = db.Column(db.String(16), nullable=False, default="unused")  ##:MySQL/Oracle
    status = db.Column(db.String(16), nullable=False, server_default=db.text("'unused'")) ##:Oracle
