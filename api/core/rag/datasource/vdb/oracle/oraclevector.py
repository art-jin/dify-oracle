    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OracleVector:
        ...
        return OracleVector(
            ...
            config=OracleVectorConfig(
                host=dify_config.ORACLE_VECTOR_HOST,
                port=dify_config.ORACLE_VECTOR_PORT,
                user=dify_config.ORACLE_VECTOR_USER,
                password=dify_config.ORACLE_VECTOR_PASSWORD,
                database=dify_config.ORACLE_VECTOR_DATABASE,
            ),
        )
