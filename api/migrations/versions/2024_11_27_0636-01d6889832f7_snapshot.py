...
Revises:
Create Date: 2024-11-27 06:36:32.936700
...
def upgrade():
    ...
    op.create_table(
        "account_integrates",
        sa.Column("id", models.types.StringUUID(), nullable=False, server_default=sa.text("SYS_GUID()")), #Oracle:SYS_GUID()
    ...
    op.create_table(
        ...
        sa.Column("tenant_id", models.types.StringUUID(), nullable=False),
        sa.Column("name", sa.String(length=255), nullable=False),
        sa.Column("description", sa.Text(), nullable=True), #Oracle False 2 True
        ...
        #sa.Column("enable_site", sa.Boolean(), nullable=False),#Oracle
        # sa.Column("enable_api", sa.Boolean(), nullable=False),#Oracle
        sa.Column('enable_site', sa.Integer(), server_default=sa.text('0'), nullable=False),
        sa.Column('enable_api', sa.Integer(), server_default=sa.text('0'), nullable=False),
        ...
        #sa.Column("is_demo", sa.Boolean(), server_default=sa.text("false"), nullable=False),#Oracle
        #sa.Column("is_public", sa.Boolean(), server_default=sa.text("false"), nullable=False),#Oracle
        #sa.Column("is_universal", sa.Boolean(), server_default=sa.text("false"), nullable=False),#Oracle
        sa.Column('is_demo', sa.Integer(), server_default=sa.text('0'), nullable=False),
        sa.Column('is_public', sa.Integer(), server_default=sa.text('0'), nullable=False),
        sa.Column("is_universal", sa.Integer(), server_default=sa.text('0'), nullable=False),
        ...
        sa.Column("updated_by", models.types.StringUUID(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        #sa.Column("use_icon_as_answer_icon", sa.Boolean(), server_default=sa.text("false"), nullable=False),#Oracle
        sa.Column("use_icon_as_answer_icon", sa.Integer(), server_default=sa.text('0'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        #sa.Column("is_deleted", sa.Boolean(), server_default=sa.text("false"), nullable=False),#Oracle
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        #sa.Column("disabled", sa.Boolean(), server_default=sa.text("false"), nullable=True),#Oracle
        sa.Column("disabled", sa.Integer(), server_default=sa.text('0'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("provider", sa.String(length=255), nullable=False),
        sa.Column("source_info", models.types.AdjustedJSON(sa.CLOB), nullable=False),   #Oracle
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        #sa.Column("disabled", sa.Boolean(), server_default=sa.text("false"), nullable=True),#Oracle
        sa.Column("disabled", sa.Integer(), server_default=sa.text('0'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("account_id", models.types.StringUUID(), nullable=False),
        sa.Column("tenant_id", models.types.StringUUID(), nullable=False),
        #sa.Column("has_permission", sa.Boolean(), server_default=sa.text("true"), nullable=False),#Oracle
        sa.Column("has_permission", sa.Integer(), server_default=sa.text('1'), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", models.types.StringUUID(), nullable=False,server_default=sa.text("SYS_GUID()")),
        sa.Column("tenant_id", models.types.StringUUID(), nullable=False),
        sa.Column("name", sa.String(length=1024), nullable=True),#Oracle : False 2 True
        sa.Column("description", sa.Text(), nullable=True),
        sa.Column("provider", sa.String(length=255), nullable=False,server_default=sa.text("'vendor'")),#Oracle : False 2 True
        sa.Column("permission", sa.String(length=255), nullable=False, server_default=sa.text("'only_me'")),
    ...
    op.create_table(
        ...
        sa.Column("keywords", AdjustedJSON(sa.CLOB), nullable=True),  ##Oracle
        ...
        #sa.Column("enabled", sa.Boolean(), server_default=sa.text("true"), nullable=False),#Oracle
        ...
        sa.Column("status", sa.String(length=255), nullable=False,server_default=sa.text("'waiting'")),#Oracle
        sa.Column("created_by", models.types.StringUUID(), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        sa.Column("updated_by", models.types.StringUUID(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("completed_at", sa.DateTime(), nullable=True),
        #sa.Column("is_paused", sa.Boolean(), server_default=sa.text("false"), nullable=True),#Oracle
        sa.Column("is_paused", sa.Integer(), server_default=sa.text('0'), nullable=False),
        sa.Column("paused_by", models.types.StringUUID(), nullable=True),
        sa.Column("paused_at", sa.DateTime(), nullable=True),
        sa.Column("error", sa.Text(), nullable=True),
        sa.Column("stopped_at", sa.DateTime(), nullable=True),
        sa.Column("indexing_status", sa.String(length=255), nullable=False, server_default=sa.text("'waiting'")),#Oracle
        #sa.Column("enabled", sa.Boolean(), server_default=sa.text("true"), nullable=False),
        sa.Column("enabled", sa.Integer(), server_default=sa.text('1'), nullable=False),
        sa.Column("disabled_at", sa.DateTime(), nullable=True),
        sa.Column("disabled_by", models.types.StringUUID(), nullable=True),
        #sa.Column("archived", sa.Boolean(), server_default=sa.text("false"), nullable=False),#Oracle
    ...
    op.create_table(
        ...
        #sa.Column("is_anonymous", sa.Boolean(), server_default=sa.text("true"), nullable=False),#Oracle
        sa.Column("is_anonymous", sa.Integer(), server_default=sa.text('1'), nullable=False),
    ...
    with op.batch_alter_table("external_knowledge_bindings", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "external_knowledge_bindings_external_knowledge_api_idx", ["external_knowledge_api_id"], unique=False
        )
        batch_op.create_index(
            "external_knowledge_bindings_external_knowledge_idx", ["external_knowledge_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("position", sa.Integer(), nullable=False),
        #sa.Column("is_pinned", sa.Boolean(), server_default=sa.text("false"), nullable=False),#Oracle
        sa.Column("is_pinned", sa.Integer(), server_default=sa.text('0'), nullable=False),
        sa.Column("last_used_at", sa.DateTime(), nullable=True),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("content", AdjustedJSON(sa.CLOB), nullable=True),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("model_name", sa.String(length=255), nullable=False),
        sa.Column("model_type", sa.String(length=40), nullable=False),
        #sa.Column("enabled", sa.Boolean(), server_default=sa.text("true"), nullable=False),#Oracle #Oracle
        #sa.Column("load_balancing_enabled", sa.Boolean(), server_default=sa.text("false"), nullable=False),
        sa.Column("enabled", sa.Integer(), server_default=sa.text('1'), nullable=False),
        sa.Column("load_balancing_enabled", sa.Integer(), server_default=sa.text('0'), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("model_type", sa.String(length=40), nullable=False),
        sa.Column("encrypted_config", sa.Text(), nullable=True),
        #sa.Column("is_valid", sa.Boolean(), server_default=sa.text("false"), nullable=False),#Oracle
    ...
    op.create_table(
        ...
        sa.Column("custom_disclaimer", sa.CLOB(), server_default=sa.text("'default'"), nullable=False),  #Arthur:Oracle
    ...
    op.create_table(
        ...
        sa.Column("tenant_id", models.types.StringUUID(), nullable=False),
        sa.Column("account_id", models.types.StringUUID(), nullable=False),
        #sa.Column("current", sa.Boolean(), server_default=sa.text("false"), nullable=False),#Oracle
    ...
    op.create_table(
        ...
        sa.Column("tool_name", sa.String(length=40), nullable=False),
        sa.Column("encrypted_credentials", sa.Text(), nullable=True),
        #sa.Column("is_enabled", sa.Boolean(), server_default=sa.text("false"), nullable=False),#Oracle
        sa.Column('is_enabled', sa.Integer(), server_default=sa.text('0'), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("features", sa.CLOB(), nullable=False),
        sa.Column("created_by", models.types.StringUUID(), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        sa.Column("updated_by", models.types.StringUUID(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("answer", sa.Text(), nullable=True),##Oracle 0323
        sa.Column("answer_tokens", sa.Integer(), server_default=sa.text("0"), nullable=False),
        sa.Column("answer_unit_price", sa.Numeric(precision=10, scale=4), nullable=False),
        sa.Column(
            "answer_price_unit", sa.Numeric(precision=10, scale=7), server_default=sa.text("0.001"), nullable=False
        ...
        sa.Column('agent_based', sa.Integer(), server_default=sa.text('0'), nullable=False),
        sa.Column("workflow_run_id", models.types.StringUUID(), nullable=True),
